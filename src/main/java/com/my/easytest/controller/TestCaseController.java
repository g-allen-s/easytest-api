...
import com.my.easytest.dto.testcase.AddTestCaseDto;
import com.my.easytest.dto.testcase.QueryTestCaseListDto;
import com.my.easytest.dto.testcase.UpdateTestCaseDto;
...
public class TestCaseController {
    ...
    public ResultDto saveText(HttpServletRequest request, @RequestBody AddTestCaseDto addTestCaseDto){
        ...
        CopyUtil.copyPropertiesCglib(addTestCaseDto, testCase);
    ...
    @ApiOperation(value = "批量新增测试用例", notes="仅用于测试用户")
    @PostMapping("file")
    public ResultDto saveFile(HttpServletRequest request, @RequestParam("caseFile") MultipartFile caseFile, AddTestCaseDto addTestCaseDto) throws IOException {
    ...
    public ResultDto<TestCase> update(HttpServletRequest request, @RequestBody UpdateTestCaseDto updateTestCaseDto){
        ...
        log.info("修改测试用例-入参= "+ JSONObject.toJSONString(updateTestCaseDto));
        ...
        TestCase testCase = new TestCase();
        CopyUtil.copyPropertiesCglib(updateTestCaseDto, testCase);
    ...
    public ResultDto<PageTableResponse<TestCase>> list(HttpServletRequest request, PageTableRequest<QueryTestCaseListDto> pageTableRequest){
        ...
        ResultDto<PageTableResponse<TestCase>> responseResultDto = testCaseService.list(pageTableRequest);
